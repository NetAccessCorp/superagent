...
/**
 * Return a parsed complete path string including the query string
 *
 * @api public
 */
Request.prototype.parsed_url = function(){
  var url = parse(this.request().path).pathname;
  ...
  url += querystring.length
    ...
    : '';
  return url_parser(this.protocol + '//' + this.host + url);
};
...
Request.prototype.end = function(fn){
  ...
  // querystring
  try {
    var parsed_url = this.parsed_url();
    req.path = parsed_url['pathname'] + parsed_url['query'];
  } catch (e) {
